...
const correlationIdMiddleware = (req: Request, res: Response, next: NextFunction): void => {
  req.correlationId = req.headers['x-correlation-id'] as string || `api_${Date.now()}_${Math.random().toString(36).slice(2)}`;
 ...
 */
const initializeRoutes = (mongoClient: MongoClient | null): Router => {
  ...
  router.post('/jobs',
    ...
    (req: Request, res: Response) => scrapingController.submitJob(req, res),
  );
  ...
  router.get('/jobs',
    ...
    correlationIdMiddleware,
    (req: Request, res: Response) => scrapingController.listJobs(req, res),
  );
  ...
  router.get('/jobs/:jobId/status',
    ...
    correlationIdMiddleware,
    (req: Request<{ jobId: UUID }>, res: Response) => scrapingController.getJobStatus(req, res),
  );
  ...
  router.get('/jobs/:jobId/results',
    ...
    correlationIdMiddleware,
    (req: Request<{ jobId: UUID }, {}, {}, { format?: string }>, res: Response) => 
      scrapingController.getJobResults(req, res),
  );
  ...
  router.delete('/jobs/:jobId',
    ...
    correlationIdMiddleware,
    (req: Request<{ jobId: UUID }>, res: Response) => scrapingController.cancelJob(req, res),
  );
