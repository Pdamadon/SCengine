/**
 * Test: Original MegaMenuStrategy (non-enhanced) on glasswingshop.com
 * This tests the original working MegaMenuStrategy that was finding triggers
 */
...
async function testOriginalMegaNav() {
  ...
  try {
    ...
    console.log('\n🎯 ORIGINAL MEGANAV STRATEGY RESULTS:');
...
module.exports = testOriginalMegaNav;