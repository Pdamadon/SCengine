...
class ValidationService {
   ...
   */
  validateTargetUrl(value, helpers) {
    try {
...
module.exports = {
  validationService,
  validateScrapingJob: validationService.validateScrapingJob.bind(validationService),
  validateJobQuery: validationService.validateJobQuery.bind(validationService),
  validateJobId: validationService.validateJobId.bind(validationService),
};
